            ...
            # Check if the user has sent a text message.
                ...
                if message_body.split()[0] in ["hi", "hello", "hallo"]:
                    ...
                    response_messages.append(TextMessage(
                        ...
                        keyboards=[SuggestedResponseKeyboard(responses=[TextResponse("1"), TextResponse("2"), TextResponse("3"), TextResponse("4"), TextResponse("5")])]))
...
if __name__ == "__main__":
    ...
    kik.set_configuration(Configuration(webhook='https://7c50a1a4.ngrok.io/incoming'))
